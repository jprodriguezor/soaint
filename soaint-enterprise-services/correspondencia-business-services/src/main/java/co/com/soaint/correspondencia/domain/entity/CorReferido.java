...
public class CorReferido implements Serializable {
    ...
    private BigDecimal ideReferido;
    ...
    public CorReferido(BigDecimal ideReferido) {
        this.ideReferido = ideReferido;
    }

    public BigDecimal getIdeReferido() {
        return ideReferido;
    }

    public void setIdeReferido(BigDecimal ideReferido) {
        this.ideReferido = ideReferido;
    }
