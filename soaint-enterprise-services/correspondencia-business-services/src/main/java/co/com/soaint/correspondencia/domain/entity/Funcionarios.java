...
public class Funcionarios implements Serializable {
    ...
    @OneToMany(mappedBy = "ideFunci")
    private List<DctAsignacion> dctAsignacionList;

    public Funcionarios() {
    }

    public Funcionarios(BigDecimal ideFunci) {
        this.ideFunci = ideFunci;
    }

    public Funcionarios(BigDecimal ideFunci, String codTipDocIdent, String nroIdentificacion, String nomFuncionario, String valApellido1, String codCargo, String codOrgaAdmi, String loginName) {
        this.ideFunci = ideFunci;
    ...
    public BigDecimal getIdeFunci() {
        return ideFunci;
    }

    public void setIdeFunci(BigDecimal ideFunci) {
        this.ideFunci = ideFunci;
    }
