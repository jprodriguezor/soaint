...
@ToString
public class PlanillaSalidaDTO implements Serializable {
    ...
    public PlanillaSalidaDTO(BigInteger idePlanilla, String nroPlanilla, Date fecGeneracion, String codTipoPlanilla,
