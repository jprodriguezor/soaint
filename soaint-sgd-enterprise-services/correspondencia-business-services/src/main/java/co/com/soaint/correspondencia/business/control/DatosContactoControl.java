    ...
    public DatosContactoFullDTO datosContactoTransformToFull(DatosContactoDTO contactoDTO) throws SystemException, BusinessException{
        try{
            return DatosContactoFullDTO.newInstance()
                    ...
                    .descTipoVia(constantesControl.consultarConstanteByCodigo(contactoDTO.getCodTipoVia()).getNombre())
                    .descPrefijoCuadrant(constantesControl.consultarConstanteByCodigo(contactoDTO.getCodPrefijoCuadrant()).getNombre())
