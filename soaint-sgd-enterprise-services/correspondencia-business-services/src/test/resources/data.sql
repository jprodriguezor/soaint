...
INSERT INTO FUNCIONARIOS(IDE_FUNCI, COD_TIP_DOC_IDENT, NRO_IDENTIFICACION, NOM_FUNCIONARIO, VAL_APELLIDO1, VAL_APELLIDO2, COD_CARGO,
                          CORR_ELECTRONICO, COD_ORGA_ADMI, LOGIN_NAME, ESTADO)
       VALUES ('1','COD_TIP_DOC_IDENT','NRO_IDENTIFICACION','NOM_FUNCIONARIO1','VAL_APELLIDO1','VAL_APELLIDO2','COD_CARGO','CORR_ELECTRONICO','COD_ORGA_ADMI',
              'LOGIN_NAME','ACTIVO');
INSERT INTO FUNCIONARIOS(IDE_FUNCI, COD_TIP_DOC_IDENT, NRO_IDENTIFICACION, NOM_FUNCIONARIO, VAL_APELLIDO1, VAL_APELLIDO2, COD_CARGO,
                          CORR_ELECTRONICO, COD_ORGA_ADMI, LOGIN_NAME, ESTADO)
       VALUES ('2','COD_TIP_DOC_IDENT','NRO_IDENTIFICACION','NOM_FUNCIONARIO1','VAL_APELLIDO1','VAL_APELLIDO2','COD_CARGO','CORR_ELECTRONICO','COD_ORGA_ADMI',
