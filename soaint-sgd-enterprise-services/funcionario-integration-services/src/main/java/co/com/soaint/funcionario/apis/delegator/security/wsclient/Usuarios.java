 ...
 *       &lt;sequence>
 *         &lt;element name="usuario" type="{http://www.soaint.com/services/security-cartridge/1.0.0}PrincipalContext" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Usuarios {
    ...
    protected List<PrincipalContext> usuario;
     ...
     * 
     */
    public List<PrincipalContext> getUsuario() {
        if (usuario == null) {
            usuario = new ArrayList<PrincipalContext>();
        }
        return this.usuario;
    }
