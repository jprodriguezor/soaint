...
public class ContentControlAlfrescoTest {
    ...
    public void test_descargarDocumento_success() {
        ...
        documentoDTO1.setIdDocumento("sdasdasdasd");
        assertEquals("2222",contentControlAlfresco.descargarDocumento(documentoDTO1,conexion.getSession()).getCodMensaje());
    }
    ...
    public void test_subirDocumentoPrincipalAdjunto_success() {
        MensajeRespuesta mensajeRespuesta1;

        DocumentoDTO documentoDTO1 = new DocumentoDTO();
        documentoDTO1.setTipoDocumento("application/pdf");
        documentoDTO1.setNombreDocumento("TestMetodoSubirDoc");
