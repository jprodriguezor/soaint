...
public class ECMConnectionRule implements TestRule {
    ...
    public Statement apply(Statement statement, Description description) {
        ...
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                unidadDocumentalDTOList = new ArrayList<>();

                try {
                    statement.evaluate();
                } finally {

                    unidadDocumentalDTOList.forEach(doc -> {
                        try {
                            contentControlAlfresco.eliminarUnidadDocumental(doc.getId(), conexion.getSession());
                        } catch (Exception e) {
    ...
    public UnidadDocumentalDTO newUnidadDocumental() {

        UnidadDocumentalDTO unidadDocumental;
        //Se llenan los datos de la unidad documental
        unidadDocumental = new UnidadDocumentalDTO();
        unidadDocumental.setInactivo(true);
        //Calendar calendar
        Calendar gregorianCalendar = GregorianCalendar.getInstance();
        unidadDocumental.setFechaCierre(gregorianCalendar);
        unidadDocumental.setId(UUID.randomUUID().toString().substring(1, 20));
        unidadDocumental.setFechaExtremaInicial(gregorianCalendar);
        unidadDocumental.setSoporte("electronico");
        unidadDocumental.setNombreUnidadDocumental("UnidadDocumentalTest");
        unidadDocumental.setFechaExtremaFinal(gregorianCalendar);
        unidadDocumental.setCerrada(true);
        unidadDocumental.setCodigoSubSerie("02312");
        unidadDocumental.setCodigoSerie("0231");
        unidadDocumental.setCodigoDependencia("10001040");
        unidadDocumental.setDescriptor1("3434");
        unidadDocumental.setDescriptor2("454545");
        unidadDocumental.setAccion("");
