...
MensajeRespuesta mensajeRespuesta;
    ...
    public void Setup() {
        ...
        try {
           mensajeRespuesta = contentManager.subirDocumentoPrincipalAdjuntoContent(documentoDTO,"EE");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
   /* @After
    public void afterFunct(){
        contentManager.eliminarDocumento(mensajeRespuesta.getDocumentoDTOList().get(0).getIdDocumento());
    }*/
    @Test
    ...
    public void descargarDocumentoContent() {
        assertEquals("ssdsd",mensajeRespuesta.getMensaje());
       assertNotNull(  contentManager.descargarDocumentoContent(documentoDTO));
       assertEquals("0000",contentManager.descargarDocumentoContent(documentoDTO).getMensaje());
    }
