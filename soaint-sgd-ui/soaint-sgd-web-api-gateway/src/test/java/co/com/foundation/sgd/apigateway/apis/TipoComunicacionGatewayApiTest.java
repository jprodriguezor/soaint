...
public class TipoComunicacionGatewayApiTest {
    ...
    public void list() {
        // given
        TipoComunicacionGatewayApi gatewayApi = new TipoComunicacionGatewayApi();
        String CONTENT = "{\"data\":100}";
        String PARENT_CODE = properties.get("contants.tipocomunicacion.value");
        ...
        // then
        ApiUtils.assertThat(TipoComunicacionGatewayApi.class, "list")
