...
public class TratamientoCortesiaClientTest {
    ...
    private String CODIGO_PADRE = propertiesRule.get("contants.tratamientocortesia.value");
    ...
    @Before
    public void setup() {
        tratamientoCortesiaClient = new TratamientoCortesiaClient();
        ReflectionTestUtils.setField(tratamientoCortesiaClient, "trataValue", CODIGO_PADRE);
    }

    @Test
    public void shouldGetResponseOfTratamientoCortesiaActivos() {
