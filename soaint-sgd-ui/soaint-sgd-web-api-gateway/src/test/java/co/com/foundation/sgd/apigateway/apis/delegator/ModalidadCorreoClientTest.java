...
public class ModalidadCorreoClientTest {
    ...
    private String CODIGO_PADRE = propertiesRule.get("contants.modalidadcorreo.value");

    private ModalidadCorreoClient modalidadCorreoClient;

    @Before
    public void setup() {
        modalidadCorreoClient = new ModalidadCorreoClient();
        ReflectionTestUtils.setField(modalidadCorreoClient, "tipoValue", CODIGO_PADRE);
    }
    ...
    public void shouldGetResponseOfBisActivos() {
        ...
        // when
        Response response = modalidadCorreoClient.list();
