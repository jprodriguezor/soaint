...
@Path("/modalidad-correo-gateway-api")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@Log4j2

public class ModalidadCorreoGatewayApi {

    @Autowired
    private ModalidadCorreoClient client;

    public  ModalidadCorreoGatewayApi(){
    ...
    public Response list() {
        ...
        log.info("ModalidadCorreoGatewayApi - [content] : " + responseContent);
